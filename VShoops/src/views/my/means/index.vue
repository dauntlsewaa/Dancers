        ...
        <el-card style="min-height: 650px">
            ...
            <el-form inline label-width="120px">
                ...
                <el-form-item style="margin-left: 160px" label="兴趣技能：">
                    <el-tag class="tags" v-for="item in tags" :key="item.id" style="width: 100px; height: 40px;"  @click="handlerColor(item, tags)">
                        {{ item.name }}
            ...
            <div style="background-color: #f5f7f9; width: 1200px; margin: 0 auto">
                ...
                <el-dialog v-model="dialogVisible" draggable>
                    ...
                    <div class="el-from" style="margin: 15px 0">
                        <el-input v-model="input" placeholder="搜索兴趣技能" style="width: 180px" icon="el-icon-zoom-out">
                        </el-input>
                    ...
                    <el-scrollbar height="500px">
                        <el-tag v-for="(item, index) in items" :key="item.id" :type="item.type"
                            ...
                            {{ item.name }}
                            <svg t="1666098282249" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="2522" width="24" height="24" class="tagIcon"
                                v-if="item.isShow">
                                <path
                    ...
                    <div class="dialog-footer">
                        ...
                        <el-button type="danger" style="width: 130px; height: 40px" @click="dialogVisible = false"
                            color="#f93684">
                            确认</el-button>
                    </div>
                </el-dialog>
